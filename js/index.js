...
(function(){
    ...
    // var myChart=document.querySelector('.bar .chart')
// 指定图表的配置项和数据
    var option = {
        color: ["#2f89cf"],
        grid: {
...
(function(){
    ...
    // 带点击切换效果
    // document.querySelector('.aClick').onclick=function changeYear(e){
    //     var i= yearData.indexOf(e.target.innerText)
...
// 折线图2
(function(){
    var myChart=echarts.init(document.querySelector('.line .chart2'))
    var option = {
        tooltip: {
            // 触发方式
            trigger: 'axis',
